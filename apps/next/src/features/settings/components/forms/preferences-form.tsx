...
const ThemePreview = ({ base, card, muted, accent }: ThemePreviewProps) => {
  return (
    <div className="items-center rounded-md p-1 border-2 border-transparent hover:border-accent">
      <div
        className={cn('flex flex-col gap-2 rounded-xs p-2 bg-[#ecedef]', base)}
      >
        <div
          className={cn(
            'flex flex-col gap-2 rounded-md p-2 shadow-xs bg-white',
            card,
          )}
        >
        ...
        <div
          className={cn(
            'flex items-center gap-2 rounded-md p-2 shadow-xs bg-white',
            card,
          )}
        >
